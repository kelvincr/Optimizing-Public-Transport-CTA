...
class Producer:
    ...
    def __init__(
        ...
        self.broker_properties = {
            ...
            "client.id": f"producer.{self.topic_name}",
        }
        ...
        if self.topic_name not in Producer.existing_topics:
            ...
            if exists is False:
                self.create_topic(client, self.topic_name)
    ...
    def create_topic(self):
        ...
        for _, future in futures.items():
            try:
                ...
                logger.info(f"topic creation kafka failed {self.topic_name} with exception: {e}")
